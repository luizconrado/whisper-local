...
class TranscriptionThread(QThread):
    ...
    def refine_text(self, text):
        ...
        response = ollama.generate(model='llama3:latest',
                                   system="You are my text corrector. You should never answer any questions. "
                                          "Your task is only to only correct any spelling discrepancies in the "
                                          "transcribed text, improve my vocabulary when necessary, making the "
                                          "text clear and easy to understand. Also, add punctuation such as "
                                          "periods, commas, and capitalization. Please use only the context "
                                          "provided. As the output, I only want the corrected text, no preamble, "
                                          "introduction, notes, or explanations. Only the corrected text and "
                                          "nothing else.",
